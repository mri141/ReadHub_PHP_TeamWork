...
<html lang = "eng">
	<head>
		<title>ReadHub - Library Management System</title>
		<meta charset = "utf-8" />
	...
	<body style = "background-color:#d3d3d3;">
		<nav class = "navbar navbar-default navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					...
					<h4 class = "navbar-text navbar-right">ReadHub - Library Management System</h4>
				</div>
			</div>
		</nav>
		<div class = "container-fluid">
		...
		<nav class = "navbar navbar-default navbar-fixed-bottom">
			<div class = "container-fluid">
				<label class = "navbar-text pull-left">Developed By: Rashed & Farid</label>
				<label class = "navbar-text pull-right">ReadHub - Library Management System &copy; All rights reserved 2018</label>
			</div>
		</nav>
	</body>
